...
class MediaPlayer2Player(ServiceInterface):
    ...
    @method()
    def Seek(self, Offset: "x") -> None:  # noqa: N803, ARG002
        pass

    @method()
    def SetPosition(self, TrackId: "o", Position: "x") -> None:  # noqa: N803, ARG002
        pass

    @method()
    def OpenUri(self, Uri: "s") -> None:  # noqa: N803, ARG002
        pass
